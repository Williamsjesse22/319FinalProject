/**
 * should not need this file for pet adoption
 */
...
// 				throw new Error(
// 					`Failed to fetch contacts: ${errorMessage.error}`
// 				);
// 			}
...
// 				const errorMessage = await response.json();
// 				throw new Error(
// 					`Failed to fetch messages: ${errorMessage.error}`
// 				);
// 			}
// 			const data = await response.json();
...
// 		try {
// 			const response = await fetch(
// 				'http://localhost:8081/contact/messages',
// 				{
// 					method: 'POST',
